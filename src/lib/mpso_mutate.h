...
// does not set model
void mpso_mutate_conf2(output_type& c, output_type& c_1, const model& m, fl amplitude, rng& generator, pso*, const precalculate&, const igrid&, change&, const vec&, quasi_newton&, int, int, int, int);
...
void pso_mutate_conf1(output_type& c, output_type& c_1, const model& m, fl amplitude, rng& generator, pso*, const precalculate&, const igrid&, change&, const vec&, quasi_newton&, int, int, int);
